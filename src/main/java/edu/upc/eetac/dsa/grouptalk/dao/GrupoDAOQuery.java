...
public class GrupoDAOQuery {
    ...
    public final static String GET_GRUPO_BY_ID = "select hex(s.id) as id, grupo.nombre, grupo.creation_timestamp, grupo.last_modified, users u where grupo.id=unhex(?)";
